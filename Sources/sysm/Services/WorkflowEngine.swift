...
struct WorkflowEngine {
    ...
    struct StepResult: Codable {
        ...
        static func skipped(name: String) -> StepResult {
            return StepResult(
                name: name,
                success: true,
                exitCode: 0,
    ...
    struct WorkflowResult: Codable {
        ...
        func formatted(verbose: Bool = false) -> String {
            var output = ""
    ...
    func listWorkflows(in directory: String? = nil) throws -> [(path: String, workflow: Workflow)] {
